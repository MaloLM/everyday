...
contextBridge.exposeInMainWorld('electron', {
  ...
  loadGiftIdeasData: () => ipcRenderer.invoke('gi:load'),
  saveGiftIdea: (idea) => ipcRenderer.invoke('gi:save', idea),
  deleteGiftIdea: (ideaId) => ipcRenderer.invoke('gi:delete', ideaId),
